...
<head>
    ...
    <title>Automatic Slat Covers</title>
...
<body style="font-family: Montserrat, sans-serif;">
    ...
    <h1 id="heading1">Automatic Slat Covers<br></h1>
    ...
    <div class="container2" id="elitepool" style="margin-bottom: 25px;margin-top:10px">
        ...
        <ul style="" class="para font14">
            ...
            <li>Blanket is stored away, out-of-sight when not in use (this extends the pool blanket life)
                Saves time and money</li>
        ...
        <p style="text-align: justify;" class="font14">
            ...
            Ever since 1989 Elite Pool Covers have been creating a wide range of automatic and manual pool cover systems for pool owners who embrace innovation, safety and security, while also having a keen eye for design and style.<br><br>

            Elite quality simply cannot be found in other pool cover systems… insist on Elite Pool Covers!<br><br>

            View our Hideaway Rollers Image Gallery below! Ask about our DIY Hideaway kit sets,that will SAVE you hundreds $$<br><br>
